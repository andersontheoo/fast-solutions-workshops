...
O objetivo do projeto é gerenciar workshops e a participação de colaboradores, permitindo análise e rastreamento de colaboradores nos eventos.
...
A API estará disponível em:https://localhost:xxxx/swagger
